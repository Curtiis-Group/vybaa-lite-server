...
router.post("/image", auth_middleware_1.authMiddleware, uploadController.uploadImage);
// DELETE /api/v1/upload/image - Delete image from Cloudinary
router.delete("/image", auth_middleware_1.authMiddleware, uploadController.deleteImage);
