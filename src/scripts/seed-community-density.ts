...
type CommunityProfile = readonly [
  id: string,
  name: string,
  description: string,
  category: string,
...
const coreCommunityProfiles: readonly CommunityProfile[] = [
...
function createGeneratedCommunityProfile(index: number): CommunityProfile {
...
const generatedCommunityProfiles = Array.from(
  { length: 100 - coreCommunityProfiles.length },
  (_, index) => createGeneratedCommunityProfile(index),
);
